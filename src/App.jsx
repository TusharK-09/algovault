...
const LEARN_PATTERNS = [{"id":"bs","label":"Binary Search","emoji":"\ud83d\udd0d","accent":"#9333ea","weakness":1,"placement":"\ud83d\udd34 High","timeEstimate":"3-4 days","template":"// BINARY SEARCH TEMPLATE\nint lo = 0, hi = n - 1;\nwhile (lo <= hi) {\n    int mid = lo + (hi - lo) / 2;\n    if (arr[mid] == target) return mid;\n    else if (arr[mid] < target) lo = mid + 1;\n    else hi = mid - 1;\n}\nreturn -1;\n\n// BS ON ANSWER TEMPLATE\nint lo = min_possible, hi = max_possible;\nwhile (lo < hi) {\n    int mid = lo + (hi - lo) / 2;\n    if (canAchieve(mid)) hi = mid;   // or lo = mid + 1\n    else lo = mid + 1;               // depending on direction\n}\nreturn lo;","insight":"Binary Search is not just for sorted arrays. Any time you can say 'if X works, anything bigger also works' \u2014 that's BS on answer. The key is defining lo/hi correctly and knowing which half to eliminate.","problems":[{"id":"bs1","name":"Binary Search","lc":"704","diff":"Easy","tag":"classic","link":"https://leetcode.com/problems/binary-search/"},{"id":"bs2","name":"Search Insert Position","lc":"35","diff":"Easy","tag":"lower bound","link":"https://leetcode.com/problems/search-insert-position/"},{"id":"bs3","name":"Find First and Last Position","lc":"34","diff":"Medium","tag":"lower/upper bound","link":"https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/"},{"id":"bs4","name":"Search in Rotated Sorted Array","lc":"33","diff":"Medium","tag":"rotated","link":"https://leetcode.com/problems/search-in-rotated-sorted-array/"},{"id":"bs5","name":"Find Minimum in Rotated Array","lc":"153","diff":"Medium","tag":"rotated","link":"https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/"},{"id":"bs6","name":"Find Peak Element","lc":"162","diff":"Medium","tag":"peak","link":"https://leetcode.com/problems/find-peak-element/"},{"id":"bs7","name":"Koko Eating Bananas","lc":"875","diff":"Medium","tag":"BS on answer","link":"https://leetcode.com/problems/koko-eating-bananas/"},{"id":"bs8","name":"Split Array Largest Sum","lc":"410","diff":"Hard","tag":"BS on answer","link":"https://leetcode.com/problems/split-array-largest-sum/"}]},{"id":"sw","label":"Sliding Window","emoji":"\ud83e\ude9f","accent":"#2563eb","weakness":2,"placement":"\ud83d\udd34 Very High","timeEstimate":"3-4 days","template":"// FIXED WINDOW\nint sum = 0;\nfor (int i = 0; i < k; i++) sum += arr[i];\nint maxSum = sum;\nfor (int i = k; i < n; i++) {\n    sum += arr[i] - arr[i - k];\n    maxSum = Math.max(maxSum, sum);\n}\n\n// VARIABLE WINDOW (expand right, shrink left)\nint left = 0, result = 0;\nMap<Character, Integer> map = new HashMap<>();\nfor (int right = 0; right < s.length(); right++) {\n    map.merge(s.charAt(right), 1, Integer::sum); // add right\n    while (windowInvalid(map)) {                  // shrink while invalid\n        map.merge(s.charAt(left), -1, Integer::sum);\n        if (map.get(s.charAt(left)) == 0) map.remove(s.charAt(left));\n        left++;\n    }\n    result = Math.max(result, right - left + 1);  // update answer\n}","insight":"Two types: fixed window (size k) and variable window (expand until invalid, then shrink). The key question is always: WHEN is the window invalid? Define that condition and the code writes itself.","problems":[{"id":"sw1","name":"Maximum Average Subarray I","lc":"643","diff":"Easy","tag":"fixed window","link":"https://leetcode.com/problems/maximum-average-subarray-i/"},{"id":"sw2","name":"Longest Substring Without Repeating","lc":"3","diff":"Medium","tag":"variable window","link":"https://leetcode.com/problems/longest-substring-without-repeating-characters/"},{"id":"sw3","name":"Max Consecutive Ones III","lc":"1004","diff":"Medium","tag":"variable window","link":"https://leetcode.com/problems/max-consecutive-ones-iii/"},{"id":"sw4","name":"Permutation in String","lc":"567","diff":"Medium","tag":"fixed window+freq","link":"https://leetcode.com/problems/permutation-in-string/"},{"id":"sw5","name":"Longest Repeating Character Replacement","lc":"424","diff":"Medium","tag":"variable window","link":"https://leetcode.com/problems/longest-repeating-character-replacement/"},{"id":"sw6","name":"Fruit Into Baskets","lc":"904","diff":"Medium","tag":"variable window","link":"https://leetcode.com/problems/fruit-into-baskets/"},{"id":"sw7","name":"Minimum Window Substring","lc":"76","diff":"Hard","tag":"variable window","link":"https://leetcode.com/problems/minimum-window-substring/"},{"id":"sw8","name":"Sliding Window Maximum","lc":"239","diff":"Hard","tag":"deque","link":"https://leetcode.com/problems/sliding-window-maximum/"}]},{"id":"tp","label":"Two Pointers","emoji":"\ud83d\udc46\ud83d\udc46","accent":"#0891b2","weakness":3,"placement":"\ud83d\udd34 High","timeEstimate":"2-3 days","template":"// OPPOSITE ENDS (sorted array)\nint left = 0, right = n - 1;\nwhile (left < right) {\n    int sum = arr[left] + arr[right];\n    if (sum == target) { /* found */ left++; right--; }\n    else if (sum < target) left++;\n    else right--;\n}\n\n// FAST/SLOW (linked list / cycle)\nListNode slow = head, fast = head;\nwhile (fast != null && fast.next != null) {\n    slow = slow.next;\n    fast = fast.next.next;\n    if (slow == fast) return true; // cycle detected\n}\n\n// SAME DIRECTION (remove duplicates type)\nint slow = 0;\nfor (int fast = 1; fast < n; fast++) {\n    if (arr[fast] != arr[slow]) arr[++slow] = arr[fast];\n}","insight":"Three flavors: opposite ends (sorted arrays), fast/slow (linked lists, cycle detection), same direction (in-place modification). Identify which type based on: sorted? linked list? need to modify in place?","problems":[{"id":"tp1","name":"Valid Palindrome","lc":"125","diff":"Easy","tag":"opposite ends","link":"https://leetcode.com/problems/valid-palindrome/"},{"id":"tp2","name":"Two Sum II","lc":"167","diff":"Easy","tag":"opposite ends","link":"https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/"},{"id":"tp3","name":"3Sum","lc":"15","diff":"Medium","tag":"sort+two pointers","link":"https://leetcode.com/problems/3sum/"},{"id":"tp4","name":"Container With Most Water","lc":"11","diff":"Medium","tag":"opposite ends","link":"https://leetcode.com/problems/container-with-most-water/"},{"id":"tp5","name":"Trapping Rain Water","lc":"42","diff":"Hard","tag":"opposite ends","link":"https://leetcode.com/problems/trapping-rain-water/"},{"id":"tp6","name":"Middle of Linked List","lc":"876","diff":"Easy","tag":"fast/slow","link":"https://leetcode.com/problems/middle-of-the-linked-list/"},{"id":"tp7","name":"Linked List Cycle II","lc":"142","diff":"Medium","tag":"fast/slow","link":"https://leetcode.com/problems/linked-list-cycle-ii/"}]},{"id":"sq","label":"Stack / Queue / Monotonic","emoji":"\ud83d\udcda","accent":"#dc2626","weakness":4,"placement":"\ud83d\udfe1 Medium","timeEstimate":"2-3 days","template":"// MONOTONIC STACK (next greater element)\nStack<Integer> stack = new Stack<>();\nint[] result = new int[n];\nArrays.fill(result, -1);\nfor (int i = 0; i < n; i++) {\n    while (!stack.isEmpty() && arr[stack.peek()] < arr[i]) {\n        result[stack.pop()] = arr[i]; // arr[i] is next greater\n    }\n    stack.push(i);\n}\n\n// VALID PARENTHESES PATTERN\nStack<Character> stack = new Stack<>();\nfor (char c : s.toCharArray()) {\n    if (c == '(') stack.push(c);\n    else if (!stack.isEmpty() && matches(stack.peek(), c)) stack.pop();\n    else return false;\n}\nreturn stack.isEmpty();","insight":"Monotonic stack is the key insight \u2014 maintain a stack that is always increasing or decreasing. Used for 'next greater/smaller element' problems. When you pop, you've found the answer for that element.","problems":[{"id":"sq1","name":"Valid Parentheses","lc":"20","diff":"Easy","tag":"stack","link":"https://leetcode.com/problems/valid-parentheses/"},{"id":"sq2","name":"Min Stack","lc":"155","diff":"Medium","tag":"design","link":"https://leetcode.com/problems/min-stack/"},{"id":"sq3","name":"Daily Temperatures","lc":"739","diff":"Medium","tag":"monotonic stack","link":"https://leetcode.com/problems/daily-temperatures/"},{"id":"sq4","name":"Next Greater Element I","lc":"496","diff":"Easy","tag":"monotonic stack","link":"https://leetcode.com/problems/next-greater-element-i/"},{"id":"sq5","name":"Car Fleet","lc":"853","diff":"Medium","tag":"monotonic stack","link":"https://leetcode.com/problems/car-fleet/"},{"id":"sq6","name":"Largest Rectangle in Histogram","lc":"84","diff":"Hard","tag":"monotonic stack","link":"https://leetcode.com/problems/largest-rectangle-in-histogram/"},{"id":"sq7","name":"Sliding Window Maximum","lc":"239","diff":"Hard","tag":"monotonic deque","link":"https://leetcode.com/problems/sliding-window-maximum/"}]},{"id":"tree","label":"Trees + BST","emoji":"\ud83c\udf32","accent":"#059669","weakness":5,"placement":"\ud83d\udd34 High","timeEstimate":"4-5 days","template":"// DFS TEMPLATE (recursive)\nint dfs(TreeNode node) {\n    if (node == null) return 0; // base case\n    int left = dfs(node.left);\n    int right = dfs(node.right);\n    // process current node\n    return Math.max(left, right) + 1; // example: height\n}\n\n// BFS TEMPLATE (level order)\nQueue<TreeNode> queue = new LinkedList<>();\nqueue.offer(root);\nwhile (!queue.isEmpty()) {\n    int size = queue.size(); // current level size\n    for (int i = 0; i < size; i++) {\n        TreeNode node = queue.poll();\n        // process node\n        if (node.left != null) queue.offer(node.left);\n        if (node.right != null) queue.offer(node.right);\n    }\n}\n\n// BST PROPERTY: left < node < right\n// INORDER of BST = sorted array","insight":"For trees, always think: can I solve this recursively? What does the function return? What's the base case? BST specifically: inorder traversal gives sorted order \u2014 use this to your advantage.","problems":[{"id":"tr1","name":"Maximum Depth of Binary Tree","lc":"104","diff":"Easy","tag":"DFS","link":"https://leetcode.com/problems/maximum-depth-of-binary-tree/"},{"id":"tr2","name":"Invert Binary Tree","lc":"226","diff":"Easy","tag":"DFS","link":"https://leetcode.com/problems/invert-binary-tree/"},{"id":"tr3","name":"Binary Tree Level Order Traversal","lc":"102","diff":"Medium","tag":"BFS","link":"https://leetcode.com/problems/binary-tree-level-order-traversal/"},{"id":"tr4","name":"Diameter of Binary Tree","lc":"543","diff":"Easy","tag":"DFS","link":"https://leetcode.com/problems/diameter-of-binary-tree/"},{"id":"tr5","name":"Validate Binary Search Tree","lc":"98","diff":"Medium","tag":"BST","link":"https://leetcode.com/problems/validate-binary-search-tree/"},{"id":"tr6","name":"Kth Smallest in BST","lc":"230","diff":"Medium","tag":"BST inorder","link":"https://leetcode.com/problems/kth-smallest-element-in-a-bst/"},{"id":"tr7","name":"Lowest Common Ancestor of BST","lc":"235","diff":"Medium","tag":"BST","link":"https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/"},{"id":"tr8","name":"Binary Tree Maximum Path Sum","lc":"124","diff":"Hard","tag":"DFS","link":"https://leetcode.com/problems/binary-tree-maximum-path-sum/"}]},{"id":"heap","label":"Heap / Priority Queue","emoji":"\u26f0\ufe0f","accent":"#d97706","weakness":6,"placement":"\ud83d\udfe1 Medium","timeEstimate":"2-3 days","template":"// MIN HEAP (Java PriorityQueue default)\nPriorityQueue<Integer> minHeap = new PriorityQueue<>();\n\n// MAX HEAP\nPriorityQueue<Integer> maxHeap = new PriorityQueue<>(Collections.reverseOrder());\n\n// K LARGEST ELEMENTS PATTERN \u2014 use min heap of size k\nPriorityQueue<Integer> pq = new PriorityQueue<>();\nfor (int num : nums) {\n    pq.offer(num);\n    if (pq.size() > k) pq.poll(); // remove smallest\n}\n// pq now contains k largest\n\n// TWO HEAPS PATTERN (find median)\nPriorityQueue<Integer> maxHeap = new PriorityQueue<>(Collections.reverseOrder()); // lower half\nPriorityQueue<Integer> minHeap = new PriorityQueue<>(); // upper half","insight":"Heap is for: K largest/smallest, top K frequent, merge K sorted, find median. Key trick: for K largest use a MIN heap of size K \u2014 you keep evicting the smallest, leaving the K largest.","problems":[{"id":"hp1","name":"Kth Largest Element in Array","lc":"215","diff":"Medium","tag":"min heap","link":"https://leetcode.com/problems/kth-largest-element-in-an-array/"},{"id":"hp2","name":"Top K Frequent Elements","lc":"347","diff":"Medium","tag":"heap+freq","link":"https://leetcode.com/problems/top-k-frequent-elements/"},{"id":"hp3","name":"K Closest Points to Origin","lc":"973","diff":"Medium","tag":"max heap","link":"https://leetcode.com/problems/k-closest-points-to-origin/"},{"id":"hp4","name":"Task Scheduler","lc":"621","diff":"Medium","tag":"greedy+heap","link":"https://leetcode.com/problems/task-scheduler/"},{"id":"hp5","name":"Find Median from Data Stream","lc":"295","diff":"Hard","tag":"two heaps","link":"https://leetcode.com/problems/find-median-from-data-stream/"},{"id":"hp6","name":"Merge K Sorted Lists","lc":"23","diff":"Hard","tag":"heap","link":"https://leetcode.com/problems/merge-k-sorted-lists/"}]},{"id":"bt","label":"Backtracking","emoji":"\ud83c\udf00","accent":"#be185d","weakness":7,"placement":"\ud83d\udfe1 Medium","timeEstimate":"3-4 days","template":"// BACKTRACKING TEMPLATE\nvoid backtrack(params, currentState, result) {\n    if (baseCase) {\n        result.add(new ArrayList<>(currentState));\n        return;\n    }\n    for (choice : choices) {\n        if (isValid(choice)) {\n            currentState.add(choice);  // choose\n            backtrack(nextParams, currentState, result); // explore\n            currentState.remove(choice); // unchoose (backtrack)\n        }\n    }\n}\n\n// SUBSETS PATTERN\nvoid backtrack(int start, List<Integer> current) {\n    result.add(new ArrayList<>(current));\n    for (int i = start; i < nums.length; i++) {\n        current.add(nums[i]);\n        backtrack(i + 1, current);\n        current.remove(current.size() - 1);\n    }\n}","insight":"Backtracking = DFS on a decision tree. At each step: choose, explore, unchoose. The template is always the same \u2014 only the base case and choices change. Draw the decision tree before coding.","problems":[{"id":"bt1","name":"Subsets","lc":"78","diff":"Medium","tag":"backtracking","link":"https://leetcode.com/problems/subsets/"},{"id":"bt2","name":"Permutations","lc":"46","diff":"Medium","tag":"backtracking","link":"https://leetcode.com/problems/permutations/"},{"id":"bt3","name":"Combination Sum","lc":"39","diff":"Medium","tag":"backtracking","link":"https://leetcode.com/problems/combination-sum/"},{"id":"bt4","name":"Subsets II (with duplicates)","lc":"90","diff":"Medium","tag":"backtracking+sort","link":"https://leetcode.com/problems/subsets-ii/"},{"id":"bt5","name":"Word Search","lc":"79","diff":"Medium","tag":"grid backtracking","link":"https://leetcode.com/problems/word-search/"},{"id":"bt6","name":"N-Queens","lc":"51","diff":"Hard","tag":"backtracking","link":"https://leetcode.com/problems/n-queens/"}]},{"id":"graph","label":"Graphs","emoji":"\ud83d\udd78\ufe0f","accent":"#7c3aed","weakness":8,"placement":"\ud83d\udfe1 Medium","timeEstimate":"4-5 days","template":"// DFS ON GRID\nboolean[][] visited = new boolean[rows][cols];\nint[] dr = {0,0,1,-1};\nint[] dc = {1,-1,0,0};\nvoid dfs(int r, int c) {\n    if (outOfBounds || visited[r][c] || grid[r][c]=='0') return;\n    visited[r][c] = true;\n    for (int d = 0; d < 4; d++) dfs(r+dr[d], c+dc[d]);\n}\n\n// BFS (shortest path)\nQueue<int[]> q = new LinkedList<>();\nboolean[] visited = new boolean[n];\nq.offer(new int[]{start, 0}); visited[start] = true;\nwhile (!q.isEmpty()) {\n    int[] cur = q.poll();\n    if (cur[0] == target) return cur[1];\n    for (int neighbor : graph.get(cur[0])) {\n        if (!visited[neighbor]) { visited[neighbor]=true; q.offer(new int[]{neighbor,cur[1]+1}); }\n    }\n}\n\n// TOPOLOGICAL SORT (Kahn's BFS)\nint[] indegree = new int[n];\nQueue<Integer> q = new LinkedList<>();\nfor (int node : with indegree 0) q.offer(node);\nwhile (!q.isEmpty()) { process q.poll(), reduce neighbors indegree, add 0-indegree to q }","insight":"3 graph types for placements: grid DFS/BFS (islands), adjacency list DFS/BFS (clone graph), topological sort (course schedule). Build adjacency list first, then pick DFS or BFS based on whether you need shortest path (BFS) or just explore (DFS).","problems":[{"id":"gr1","name":"Number of Islands","lc":"200","diff":"Medium","tag":"grid DFS","link":"https://leetcode.com/problems/number-of-islands/"},{"id":"gr2","name":"Max Area of Island","lc":"695","diff":"Medium","tag":"grid DFS","link":"https://leetcode.com/problems/max-area-of-island/"},{"id":"gr3","name":"Clone Graph","lc":"133","diff":"Medium","tag":"BFS+hashmap","link":"https://leetcode.com/problems/clone-graph/"},{"id":"gr4","name":"Course Schedule","lc":"207","diff":"Medium","tag":"topological sort","link":"https://leetcode.com/problems/course-schedule/"},{"id":"gr5","name":"Course Schedule II","lc":"210","diff":"Medium","tag":"topological sort","link":"https://leetcode.com/problems/course-schedule-ii/"},{"id":"gr6","name":"Pacific Atlantic Water Flow","lc":"417","diff":"Medium","tag":"multi-source DFS","link":"https://leetcode.com/problems/pacific-atlantic-water-flow/"},{"id":"gr7","name":"Rotting Oranges","lc":"994","diff":"Medium","tag":"multi-source BFS","link":"https://leetcode.com/problems/rotting-oranges/"}]},{"id":"dp","label":"Dynamic Programming","emoji":"\ud83e\udde0","accent":"#0f766e","weakness":9,"placement":"\ud83d\udd34 High","timeEstimate":"5-6 days","template":"// DP THINKING PROCESS\n// 1. Define: dp[i] = ?\n// 2. Base case: dp[0], dp[1]\n// 3. Transition: dp[i] = f(dp[i-1], dp[i-2], ...)\n// 4. Answer: dp[n] or max(dp)\n\n// 1D DP (Fibonacci pattern)\nint[] dp = new int[n + 1];\ndp[0] = 0; dp[1] = 1;\nfor (int i = 2; i <= n; i++) dp[i] = dp[i-1] + dp[i-2];\n\n// KNAPSACK PATTERN\n// dp[i][w] = max value using first i items with weight limit w\nfor (int i = 1; i <= n; i++)\n    for (int w = 0; w <= W; w++)\n        dp[i][w] = (weight[i] <= w)\n            ? Math.max(dp[i-1][w], dp[i-1][w-weight[i]] + value[i])\n            : dp[i-1][w];\n\n// LCS / EDIT DISTANCE PATTERN\nfor (int i = 1; i <= m; i++)\n    for (int j = 1; j <= n; j++)\n        dp[i][j] = (s1[i]==s2[j]) ? dp[i-1][j-1]+1 : Math.max(dp[i-1][j], dp[i][j-1]);","insight":"DP = recursion + memoization. Always start with brute force recursion, then add a memo table. The recurrence relation is everything \u2014 spend 5 mins defining dp[i] clearly before writing any code.","problems":[{"id":"dp1","name":"Climbing Stairs","lc":"70","diff":"Easy","tag":"1D DP","link":"https://leetcode.com/problems/climbing-stairs/"},{"id":"dp2","name":"House Robber","lc":"198","diff":"Medium","tag":"1D DP","link":"https://leetcode.com/problems/house-robber/"},{"id":"dp3","name":"Unique Paths","lc":"62","diff":"Medium","tag":"2D DP","link":"https://leetcode.com/problems/unique-paths/"},{"id":"dp4","name":"Coin Change","lc":"322","diff":"Medium","tag":"unbounded knapsack","link":"https://leetcode.com/problems/coin-change/"},{"id":"dp5","name":"Longest Increasing Subsequence","lc":"300","diff":"Medium","tag":"sequence DP","link":"https://leetcode.com/problems/longest-increasing-subsequence/"},{"id":"dp6","name":"Partition Equal Subset Sum","lc":"416","diff":"Medium","tag":"0/1 knapsack","link":"https://leetcode.com/problems/partition-equal-subset-sum/"},{"id":"dp7","name":"Longest Common Subsequence","lc":"1143","diff":"Medium","tag":"2D DP","link":"https://leetcode.com/problems/longest-common-subsequence/"},{"id":"dp8","name":"Word Break","lc":"139","diff":"Medium","tag":"DP+hashset","link":"https://leetcode.com/problems/word-break/"}]},{"id":"hm","label":"HashMap / Frequency","emoji":"\ud83d\uddc2\ufe0f","accent":"#b45309","weakness":10,"placement":"\ud83d\udd34 Very High","timeEstimate":"1-2 days","template":"// FREQUENCY MAP\nMap<Integer, Integer> freq = new HashMap<>();\nfor (int num : nums) freq.merge(num, 1, Integer::sum);\n\n// PREFIX SUM + HASHMAP (subarray sum equals k)\nMap<Integer, Integer> prefixCount = new HashMap<>();\nprefixCount.put(0, 1); // empty prefix\nint sum = 0, result = 0;\nfor (int num : nums) {\n    sum += num;\n    result += prefixCount.getOrDefault(sum - k, 0);\n    prefixCount.merge(sum, 1, Integer::sum);\n}\n\n// TWO SUM PATTERN\nMap<Integer, Integer> seen = new HashMap<>();\nfor (int i = 0; i < nums.length; i++) {\n    int complement = target - nums[i];\n    if (seen.containsKey(complement)) return new int[]{seen.get(complement), i};\n    seen.put(nums[i], i);\n}","insight":"HashMap gives O(1) lookup. Core patterns: frequency counting, prefix sum + map (for subarray problems), and two-sum style complement lookup. If you see 'count occurrences' or 'find pair/subarray', think HashMap first.","problems":[{"id":"hm1","name":"Two Sum","lc":"1","diff":"Easy","tag":"complement lookup","link":"https://leetcode.com/problems/two-sum/"},{"id":"hm2","name":"Group Anagrams","lc":"49","diff":"Medium","tag":"frequency map","link":"https://leetcode.com/problems/group-anagrams/"},{"id":"hm3","name":"Subarray Sum Equals K","lc":"560","diff":"Medium","tag":"prefix sum+map","link":"https://leetcode.com/problems/subarray-sum-equals-k/"},{"id":"hm4","name":"Longest Consecutive Sequence","lc":"128","diff":"Medium","tag":"hashset","link":"https://leetcode.com/problems/longest-consecutive-sequence/"},{"id":"hm5","name":"Top K Frequent Words","lc":"692","diff":"Medium","tag":"freq+heap","link":"https://leetcode.com/problems/top-k-frequent-words/"}]}];
